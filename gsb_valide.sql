...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  sam. 28 avr. 2018 à 21:00
...
CREATE TABLE IF NOT EXISTS `fichefrais` (
  ...
  `nbJustificatifs` int(11) NOT NULL DEFAULT '0',
...
('a17', '201804', 0, NULL, '2018-04-28', 'CR');
...
CREATE TABLE IF NOT EXISTS `fraisforfait` (
  `ETP` float NOT NULL DEFAULT '110',
  `KM` float NOT NULL DEFAULT '0.62',
  `NUI` float NOT NULL DEFAULT '80',
  `REP` float NOT NULL DEFAULT '25'
...
INSERT INTO `fraisforfait` (`ETP`, `KM`, `NUI`, `REP`) VALUES
(110, 0.62, 80, 25);
...
CREATE TABLE IF NOT EXISTS `lignefraisforfait` (
  ...
  `ETP` int(11) DEFAULT NULL,
  `KM` int(11) DEFAULT NULL,
  `NUI` int(11) DEFAULT NULL,
...
INSERT INTO `lignefraisforfait` (`idVisiteur`, `mois`, `ETP`, `KM`, `NUI`, `REP`) VALUES
('a131', '201804', 0, 0, 0, 0),
('a17', '201804', 1, 2, 3, 4);
...
(2, 'a17', '201804', 'prostipute', '2018-02-05', '500.00');
